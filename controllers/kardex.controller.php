...
switch ($_GET["op"]) {
    ...
    case 'todos': //TODO: Procedimiento para cargar todos los datos del kardex
    ...
    case 'insertar':  //TODO: Procedimiento para insertar un kardex en la base de datos
        $Estado = $_POST["Estado"];
    ...
    case 'actualizar':  //TODO: Procedimiento para actualizar un kardex en la base de datos
        $idKardex = $_POST["idKardex"];
        $Estado = $_POST["Estado"];
        $Fecha_Transaccion = $_POST["Fecha_Transaccion"];
        $Cantidad = $_POST["Cantidad"];
