...
switch ($_GET["op"]) {
    ...
    case 'todos': //TODO: Procedimiento para cargar todos los datos del detalle_factura
    ...
    case 'insertar':  //TODO: Procedimiento para insertar un detalle_factura en la base de datos
    ...
    case 'actualizar':  //TODO: Procedimiento para actualziar un detalle_factura en la base de datos
        $idDetalle_Factura = $_POST["idDetalle_Factura"];
        $Cantidad = $_POST["Cantidad"];
        $Factura_idFactura = $_POST["Factura_idFactura"];
        $Kardex_idKardex = $_POST["Kardex_idKardex"];
