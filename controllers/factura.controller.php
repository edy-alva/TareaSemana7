...
switch ($_GET["op"]) {
    ...
    case 'todos': //TODO: Procedimiento para cargar todos los datos de la factura
        ...
        break;
    case 'uno': //TODO: procedimeinto para obtener un registro de la base de datos
    ...
    case 'insertar':  //TODO: Procedimiento para insertar una factura en la base de datos
        $Fecha = $_POST["Fecha"];
    ...
    case 'actualizar':  //TODO: Procedimiento para actualizar una Factura en la base de datos
        $idFactura = $_POST["idFactura"];
        $Fecha = $_POST["Fecha"];
        $Sub_total = $_POST["Sub_total"];
        $Sub_total_iva = $_POST["Sub_total_iva"];
