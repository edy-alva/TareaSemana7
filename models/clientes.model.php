...
class Clientes
{
    ...
    public function insertar($Nombres, $Direccion, $Telefono, $Cedula, $Correo) //Insert Clientes
    {
        try {
            $con = new ClaseConectar();
            $con = $con->ProcedimientoParaConectar();
    ...
    public function actualizar($idClientes, $Nombres, $Direccion, $Telefono, $Cedula, $Correo) //update Clientes
    {
        try {
            $con = new ClaseConectar($idClientes);
            $con = $con->ProcedimientoParaConectar();
